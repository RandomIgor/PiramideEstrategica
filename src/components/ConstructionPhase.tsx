  ...
  return (
    <div className="glass-panel animate-fade-in" style={{ padding: '2rem', width: '100%', maxWidth: '800px', display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ color: '#ccc', fontSize: '0.9rem', marginTop: '0.5rem' }}>Arrastra las fichas del inventario a la pirámide. Haz clic en una ficha colocada para devolverla.</p>
      </div>
          ...
          return (
            <div 
              ...
              style={{
                ...
                padding: '0.8rem 1.2rem', background: 'var(--glass-bg)', borderRadius: '12px',
                cursor: 'grab', border: '1px solid var(--glass-border)',
                transition: 'transform 0.2s'
              }}
              onMouseEnter={(e) => e.currentTarget.style.transform = 'scale(1.05)'}
              onMouseLeave={(e) => e.currentTarget.style.transform = 'scale(1)'}
            >
              <span style={{ fontSize: '2.5rem', userSelect: 'none' }}>{token.icon}</span>
